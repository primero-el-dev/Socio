...
class AcceptFatherRelationController extends MakeUserUserRelationController
{
    protected function getEventClass(): string
    {
        return AcceptFatherRelationEvent::class;
    }
    ...
    {
        return 'notification.success.relation.acceptFather';
    }
