...
class RequestGroupMemebershipEventHandler implements EventHandler
{
		...
		$this->commandBus->dispatch(
			new SendAppNotificationCommand(
				...
				$this->translator->trans(
					'notification.info.groupMembershipRequestReady.subject'),
	...
	private function getContent(string $groupName)
	{
		return sprintf(
			$this->translator->trans(
				'notification.info.groupMembershipRequestReady.content'),
			$groupName
		);
	}
}